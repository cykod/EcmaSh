...
1. Fix files to be allowed to be named anything (not like directories) - w/ spaces/etc
2. Finish tests for fetch
3. more / less command
4. Figure out hosting / directory structure
5. Tab completion
6. up / down for history
